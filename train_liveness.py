...
from keras.utils import to_categorical  # Đã sửa import
...
ap.add_argument(
    "-m", "--model", type=str, default="liveness.model", help="path to trained model"
)
ap.add_argument(
    "-l", "--le", type=str, default="le.pickle", help="path to label encoder"
)
ap.add_argument(
    "-p",
    "--plot",
